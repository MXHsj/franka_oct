...
def main():
    ...
    spat_filter.set_option(rs.option.filter_smooth_delta, 2)
    ...
    try:
        while True:
            ...
            if isRecoding:
                ...
                # depth_in_met = depth_frame.as_depth_frame().get_distance(639, 479)
                # depth_in_met = depth_frame.as_depth_frame().get_distance(0, 0)
                # print(rs.rs2_deproject_pixel_to_point(depth_intrin, [639, 479], depth_in_met))
                # print(rs.rs2_deproject_pixel_to_point(depth_intrin, [0, 0], depth_in_met))
            ...
            if key & 0xFF == ord('q') or key == 27:
                ...
                print('clear targets, saving current frame ...')
